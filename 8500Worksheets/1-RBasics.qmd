...
> In the same way that adding combines two numbers with +, paste combines two strings of characters. Similar to putting 2 + 4 (even though the order doesn't matter if you're adding numbers), paste("Amber", "lives in Easley, SC") combines two sets of characters into a sentence because I put them into the order I wanted the sentence to have.
