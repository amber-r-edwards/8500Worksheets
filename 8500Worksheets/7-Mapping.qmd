...
joplin66 <- read.csv("Joplin1966LL.csv")
joplin66 <- joplin66 %>%
  rename(
    DATE = Date,
    LATITUDE = Latitude,
...
joplin67 <- read.csv("Joplin1967LL.csv")
joplin68 <- read.csv("Joplin1968LL.csv")
joplin69 <- read.csv("Joplin1969LL.csv")
joplin70 <- read.csv("Joplin1970LL.csv")

joplinallyears <- bind_rows(joplin66, joplin67, joplin68, joplin69, joplin70)
#WHY DID I ONLY USE ALL CAPS FOR ONE CSV THAT IS SO DUMB
```
...
#Comparison of American Parks as older, larger, and further from urban areas than 
```
