...
```{r}
mindbody <- full_join(mb, metadata, join_by())
#file name and doc id not the same
```

> idea notes: use text from Mind and Body to look at how Progressive Era women's movements might impact topics; look at what changed between the Progressive Era and the 1920s; look for similarities between WWI and the Great Depression
...
> first need to save metadata as csv? - work through this later


> Join dataframes together


> idea notes: see how top td-idf scored words changed across the publication's run; 