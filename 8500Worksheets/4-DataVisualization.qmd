...
#all together
ggplot(recavgworkers, aes(x=year, y=average)) + geom_col() + facet_wrap(~type_of_worker) +labs(title="Average Number of Workers Over Time", subtitle="Faceted by Type", x="Year", y="Average Number of Workers")
...
ggplot(paidworkers, aes(x=year, y=average)) + geom_col() + facet_wrap(~type_of_worker) + labs(title="Average Number of Paid Workers Over Time", subtitle="Faceted by Gender", x="Year", y="Average Number of Workers")

#Volunteer Workers over Time
ggplot(volunteerworkers, aes(x=year, y=average)) + geom_col() + facet_wrap(~type_of_worker) + labs(title="Average Number of Volunteer Workers Over Time", subtitle="Faceted by Gender", x="Year", y="Average Number of Workers")
```
